...
public class SampleJavaMailCCAndBcc {
    ...
    private static final String USER_NAME = "kimgames1";  // GMail user name (just the part before "@gmail.com")
    private static final String PASSWORD = "kimruan920"; // GMail password

    public static void main(String[] args) {
        // Message info
        String[] to = { "contato.kimgames@gmail.com" }; // list of recipient email addresses
    ...
    private static void sendFromGMail(String[] to, String[] cc, String[] bcc, 
